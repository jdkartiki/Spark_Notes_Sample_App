 ...
 * Generated at: 2023-12-29 09:26:11 UTC
...
public final class update_005fclass_005fnotes_005for_005fquestion_005fpaper_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Update Question Paper Or Class Notes</title>\n");
   ...
   if(userNav==null){}
	...
	Documentations doc=documentationDao.getDocumentById(Long.parseLong(id));
      ...
      out.write("\t\t\t\t\t\t<h4 class=\"card-header text-center p-3 add-question-paper-css\">Update Class Notes Or Question Paper</h4>\n");
 ...
 out.println(message); 
    ...
    session.removeAttribute("msgStatus");
      ...
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t         <input type=\"hidden\" name=\"operation\" value=\"updateNotesOrQuestionSet\">\n");
      ...
      out.print( doc.getId() );
      out.write("\">\n");
      out.write("\t\t\t\t         <input type=\"hidden\" name=\"classNameId\" value=\"");
      out.print( doc.getNewsubject().getNewClassObj().getId() );
      out.write("\">\n");
      out.write("\t\t\t\t         <input type=\"hidden\" name=\"subjectNameId\" value=\"");
      out.print( doc.getNewsubject().getId() );
      out.write("\">\n");
      out.write("\t\t\t\t         <input type=\"hidden\" name=\"documentType\" value=\"");
      ...
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t             <input type=\"text\" class=\"form-control shadow-sm\" name=\"notesTitle\" value=\"");
      out.print( doc.getTitle() );
      out.write("\" placeholder=\"Enter the Notes/Question paper Name\" required>\t\t\t         \n");
      out.write("\t\t\t\t         </div>\n");
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t         <div class=\"form-group mt-3\">\n");
      out.write("\t\t\t\t             <textarea class=\"form-control shadow-sm\" name=\"notesDesc\" placeholder=\"Enter notes/Question paper Description\" required style=\"height:80px\">");
      out.print( doc.getDescription() );
      out.write("</textarea>\t\t         \n");
      out.write("\t\t\t\t         </div>\n");
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t         <div class=\"form-group mt-3\">\n");
      out.write("\t\t\t\t         <label id=\"notesFile\">Choose upload file: </label>\n");
      out.write("\t\t\t\t             <input type=\"file\" class=\"form-control shadow-sm mt-1\" name=\"notesFiles\"  value=\"");
      out.print( doc.getUploadedDocument() );
      out.write("\" id=\"notesFile\" placeholder=\"choose upload file\" required>\t\t\t         \n");
      out.write("\t\t\t\t         </div>\n");
      out.write("\t\t\t\t         \t\t\t\t         \n");
      out.write("\t\t\t\t         <div class=\"container text-center mt-3\">\n");
      out.write("\t\t\t\t            <button class=\"btn btn-outline-success\">Update Document</button>\n");
      out.write("\t\t\t\t            <form>\n");
      out.write("                                <input type=\"button\" class=\"btn btn-outline-primary\" value=\"Go Back\" onclick=\"history.go(-1)\">\n");
      out.write("                            </form>\n");
      out.write("\t\t\t\t         \n");
      out.write("\t\t\t\t         </div>\n");
      out.write("\t\t\t\t\t\t    \n");
